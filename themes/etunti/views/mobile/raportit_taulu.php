...
<div class="tray-center">
	...
	<h2 class="myBgColors p10"> <i class="glyphicon glyphicon-envelope"></i>
		<?= Yii::t('main', 'Tuntiraportti') ?>
	</h2>
								...
								<label class="field">
									<div id="tekijat_result">
										...
										$tyontekiatLista = $site[0]->tyontekiatLista(
											...
											//class
											'tyontekijat', // id
											(isset($_GET['tekijaPaaSivulla'])) ? $_GET['tekijaPaaSivulla'] : '',
											//selected
						...
						<div class="col-md-2">
							<div class="section">
								<label class="field prepend-icon">
									...
									<input type="text" class="gui-input datepickerFI" name="from" value="<?= $from ?>"
										placeholder="<?php echo Yii::t('main', 'Mistä'); ?>...">
						...
						<div class="col-md-2">
							<div class="section">
								<label class="field prepend-icon">
									...
									<input type="text" class="gui-input datepickerFI" name="to" value="<?= $to ?>"
										placeholder="<?php echo Yii::t('main', 'Mihin'); ?>...">
						...
						<table class="table table-striped" id="mobileTable">
							...
							<tfoot>
								<tr>
									...
									<td>
										<?= ($yhteensa > 0) ? $this->sprint($yhteensa) . '&nbsp;|&nbsp' . $this->num($yhteensa) : '' ?>
									</td>
									<td>
										<?= ($yhteensa_laskusumma > 0) ? $yhteensa_laskusumma : '' ?>
									</td>
								</tr>
							</tfoot>
						</table>
...
<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/dataTables.bootstrap.min.css" rel="stylesheet"
	type="text/css" />
