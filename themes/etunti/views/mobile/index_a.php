  ...
  <th data-toggle="tooltip" title="Tästä näkyy aloitus ja lopetus etäisyydet kilometri tarkuudella oikeasta työpaikkasta."><?php echo Yii::t('main', '<i class="fa fa-2x fa-question-circle"></i>'); ?></th>
