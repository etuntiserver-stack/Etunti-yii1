...
<div class="row">
  <div class="col-sm-3">
		<?php echo $form->labelEx($model,'tuoteID'); ?> <b class="fa fa-info-circle" data-toggle="tooltip" title="Huomio! Tuote/Palvelu valikko tulee automaattisesti valitsemalla kohden ja myös silloin, kun kohteen tietoihin on määritelty tuotteet ja palvelut yksikkönä h."></b>
		<?php
		$criteria = new CDbCriteria();
