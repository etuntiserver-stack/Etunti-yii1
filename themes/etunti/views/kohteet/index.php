...
?>
		...
		<?php echo CHtml::link('Massamuokkaus',Yii::app()->request->baseUrl.'/index.php/kohteet/massamuokkaus',array('class'=>'btn btn-default', 'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title' => Yii::t('main', 'Lisää kohde') )); ?>
