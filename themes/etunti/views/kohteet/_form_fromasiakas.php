...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <div class="col-sm-3">
	...
	<div class="section fill mb5">
		...
		<?php echo $form->textField($model,'etu_suku_nimet',array('value'=>$asiakas->yhteyshenkilo,'size'=>60,'maxlength'=>100,'class'=>'form-control input-sm')); ?>
	...
	<div class="section fill mb5">
		...
		<?php echo $form->textField($model,'email',array('value'=>$asiakas->sahkoposti,'size'=>60,'maxlength'=>72,'class'=>'form-control input-sm')); ?>
		<?php echo $form->error($model,'email'); ?>
	</div>

	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'puh_nro'); ?>
		<?php echo $form->textField($model,'puh_nro',array('value'=>$asiakas->puhelin,'size'=>50,'maxlength'=>50,'class'=>'form-control input-sm')); ?>
