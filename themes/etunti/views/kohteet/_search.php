...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'lyhenne',array('size'=>46,'maxlength'=>46,'class'=>'form-control input-sm')); ?>
	</div>
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'katuosoite',array('size'=>50,'maxlength'=>50,'class'=>'form-control input-sm')); ?>
	</div>
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'kenella_on_avain',array('size'=>50,'maxlength'=>50,'class'=>'form-control input-sm')); ?>
	</div>
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'siivous',array('size'=>60,'maxlength'=>100,'class'=>'form-control input-sm')); ?>
	</div>
