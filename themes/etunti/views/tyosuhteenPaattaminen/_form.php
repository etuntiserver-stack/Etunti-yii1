...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'tyosuhteen-paattaminen-form',
...
<div class="row">
  <div class="col-sm-4">
	...
	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'titteli'); ?>
		<?php echo $form->textField($model,'titteli',array('size'=>60,'maxlength'=>255, 'class'=>'form-control')); ?>
		<?php echo $form->error($model,'titteli'); ?>
	</div>
  ...
  <div class="col-sm-4">
	...
	<div class="section fill mb5">
		...
		<?php echo $form->textField($model,'loppu_pvm',array('size'=>60,'maxlength'=>50, 'class'=>'form-control datepickerFI', 'data-date-container'=>'#TyosuhteenPaattaminen_loppu_pvm')); ?>
...
<div class="row">
  <div class="col-sm-4">
	...
	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'kuuleminen'); ?>
		<?php echo $form->textArea($model,'kuuleminen',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
		<?php echo $form->error($model,'kuuleminen'); ?>
	</div>

	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'tyosuhteen_paattaminen'); ?>
		<?php echo $form->textArea($model,'tyosuhteen_paattaminen',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
		<?php echo $form->error($model,'tyosuhteen_paattaminen'); ?>
	</div>
