...
?>
	...
	<h2 class="myBgColors p10"> <i class="glyphicon glyphicon-home"></i> <?php echo Yii::t('main', 'Tarjouslaskenta'); ?> 
		<?php echo CHtml::link('',Yii::app()->request->baseUrl.'/index.php/tarjouslaskenta/create',array('class'=>'btn btn-default fa fa-plus')); ?>
	</h2>
