...
?>
        ...
        <h2 class="myBgColors p10"> <i class="glyphicon glyphicon-home"></i> <?php echo Yii::t('main', 'Yritysten loki'); ?>

	 <div class="pull-right montakoRiviaSivulle" style="margin-top: -6px">
	   <?php
