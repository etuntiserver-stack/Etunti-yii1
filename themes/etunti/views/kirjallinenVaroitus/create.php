...
?>
	   ...
	   ?>
	   <h2 class="myBgColors p10"> <i class="glyphicon glyphicon-home"></i> <?php echo Yii::t('main', 'Luo kirjallinen varoitus'); ?> </h2>
   ...
   url: 'tekijan_tiedot',
      ...
      data: { tid : tid },
		...
		data = JSON.parse(data);
			...
			$('#KirjallinenVaroitus_tid').val(tid);
			$('#KirjallinenVaroitus_tekijan_email').val(data['tekijan_email']);
			$('#KirjallinenVaroitus_tekijan_nimi').val(data['tekijan_nimi']);
			$('#KirjallinenVaroitus_tekijan_katuosoite').val(data['tekijan_katuosoite']);
			$('#KirjallinenVaroitus_tekijan_pnumero').val(data['tekijan_pnumero']);
			$('#KirjallinenVaroitus_tekijan_ptoimipaikka').val(data['tekijan_ptoimipaikka']);
			$('#KirjallinenVaroitus_tekijan_puh').val(data['tekijan_puh']);
			$('#KirjallinenVaroitus_tekijan_henkilotunnus').val(data['tekijan_henkilotunnus']);
