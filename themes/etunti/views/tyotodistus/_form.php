...
<div class="row">
  <div class="col-sm-4">
	...
	<div class="section fill mb5">
		...
		<?php echo $form->textField($model,'Alku',array('size'=>50,'maxlength'=>50, 'class'=>'form-control datepickerFI')); ?>
		<?php echo $form->error($model,'Alku'); ?>
	</div>

	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'Loppu'); ?>
		<?php echo $form->textField($model,'Loppu',array('size'=>50,'maxlength'=>50, 'class'=>'form-control datepickerFI')); ?>
	...
	<div class="section fill mb5">
		...
		<?php echo $form->textArea($model,'Tyokohde',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
	...
	<div class="section fill mb5">
		...
		<?php echo $form->textArea($model,'TyosuhteenPaattamisenSyy',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
		<?php echo $form->error($model,'TyosuhteenPaattamisenSyy'); ?>
	</div>

	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'Tyotaito'); ?>
		<?php echo $form->textArea($model,'Tyotaito',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
		<?php echo $form->error($model,'Tyotaito'); ?>
	</div>

	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'Kaytos'); ?>
		<?php echo $form->textArea($model,'Kaytos',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
		<?php echo $form->error($model,'Kaytos'); ?>
	</div>

	<div class="section fill mb5">
		<?php echo $form->labelEx($model,'Arvio'); ?>
		<?php echo $form->textArea($model,'Arvio',array('rows'=>6, 'cols'=>50, 'class'=>'form-control')); ?>
