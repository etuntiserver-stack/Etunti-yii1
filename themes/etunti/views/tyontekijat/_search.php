...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'imei',array('size'=>30,'maxlength'=>30,'class'=>'form-control input-sm')); ?>
	</div>
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'aktiivinen',array('size'=>50,'maxlength'=>50,'class'=>'form-control input-sm')); ?>
	</div>
	...
	<div class="section">
		...
		<?php echo $form->textField($model,'online_varauksen_valmina',array('class'=>'form-control input-sm')); ?>
	</div>

	<div class="section">
		<?php echo $form->label($model,'kortit'); ?>
		<?php echo $form->textArea($model,'kortit',array('rows'=>6, 'cols'=>50, 'class'=>'form-control input-sm')); ?>
	</div>

	<div class="section">
		<?php echo $form->label($model,'ayjasenyys'); ?>
		<?php echo $form->textField($model,'ayjasenyys',array('size'=>10,'maxlength'=>10,'class'=>'form-control input-sm')); ?>
	</div>
<br>
	<div class="section">
