...
?>
	...
	<h2 class="myBgColors p10"> <?php echo Yii::t('main', 'Työsopimukset'); ?> 
		<?php echo CHtml::link('',Yii::app()->request->baseUrl.'/index.php/tyosopimukset/create',array('class'=>'btn btn-default fa fa-plus')); ?>
