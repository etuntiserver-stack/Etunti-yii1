...
<p><h3>Sopimuksen syntyminen</h3></p>
...
<p>Etunti-verkkopalvelua käytetään Internet selaimella. Tilaaja voi käyttää palvelua sekä Suomessa että ulkomailla. Tietoturvateknisistä syitä Palveluntarjoaja voi rajoittaa palvelun käytettävyyttä yksittäisissä maissa. Palveluiden käyttöön ja Palveluntoimittajan velvoitteisiin sovelletaan kuitenkin kaikissa tilanteissa näiden sopimusehtojen lisäksi vain Suomen lakia.</p>
...
<p><h3>Tilaajan velvoitteet</h3></p>

<p>Tilaaja hankkii Etunti-verkkopalvelun käyttöön soveltuvat puhelimet ohjelmistoineen sekä tarvittavat tietoliikenneyhteydet ja vastaa niiden toimivuudesta, tietoturvasta sekä käyttö- ja ylläpitokustannuksista.</p>
...
<p>Tilaaja vastaa hänen tunnistetiedoillaan tehdyistä verkkopalvelun käytöstä. Mikäli Palveluntoimittajalla on syytä epäillä tunnistetietojen väärinkäyttöä tai niiden joutumista vääriin käsiin, on tällä oikeus estää Etunnin verkkopalvelunkäyttö.</p>
...
<p><h3>Palveluntoimittajanvelvoitteet</h3></p>
...
<p><h3>Palveluntoimittajan oikeudet</h3></p>

<p>Palveluntoimittajalla on oikeus rajoittaa verkkopalvelujen käyttöaikaa tai keskeyttää tilapäisesti palveluiden toimittaminen tarpeellisten huolto- ja ylläpitotoimenpiteiden suorittamista varten tai muista näihin verrattavista syistä ilmoittamalla siitä asiakkailleen verkkopalvelussa. Ilmoitus pyritään tekemään hyvissä ajoin etukäteen.</p>
...
<p>Palveluntoimittaja päättää Käyttäjälle tarjottavan tuen saatavuudesta ja sen palvelutasosta sekä veloitusperusteesta. Digisten Oy:llä on oikeus tallettaa arkistoida asiakaspalvelupuhelut ja -viestit.</p>
...
<p><h3>Sopimuksen muuttaminen</h3></p>

<p>Sopimuksen muuttaminen tai siirtäminen on mahdollista vain kummankin sopijaosapuolen hyväksymällä muutossopimuksella.</p>

<p><h3>Palveluntoimittajan vahingonkorvaus-velvollisuus</h3></p>

<p>Palveluntoimittajan vahingonkorvausvastuu palvelussa mahdollisesti ilmenevistä häiriöistä on rajoitettu välittömiin vahinkoihin, jotka ilmenevät ylimääräisinä tai hukkaan menneinä etäyhteyskustannuksina tai niihin verrattavina Asiakkaalle aiheutuneina lisäkustannuksina. Palveluntoimittaja ei siten vastaa Asiakkaalle palvelussa esiintyvien häiriöiden takia mahdollisesti aiheutuvasta taloudellisesta vahingosta kuten esimerkiksi tulon, voiton tai tuoton menetyksestä, muissa sopimussuhteissa aiheutuvista virheistä tai viivästyksistä, kolmannen osapuolen vaatimuksista taikka muusta Palveluntoimittajan kannalta vaikeasti ennakoitavasta vahingosta.</p>

<p>Palveluntoimittaja ei myöskään vastaa vahingosta, joka on aiheutunut Asiakkaan antamien tietojen puutteellisuudesta tai virheellisyydestä.</p>

<p>Palveluntoimittaja ei vastaa vahingosta, joka aiheutuu ylivoimaisesta esteestä, kuten sodasta tai lakosta; Palveluntoimittajasta riippumattomasta häiriöstä tiedon siirrossa, atk-järjestelmissä, sähköisessä viestinnässä, tai sähkön saannissa; tai vastaavasta syystä johtuvasta Palveluntoimittajan toiminnan kohtuuttomasta vaikeutumisesta.</p>

<p>Ylivoimaisen esteen johdosta Palveluntoimittaja on oikeutettu keskeyttämään palvelun toimittaminen toistaiseksi ja jatkamaan palvelua vasta kun este poistuu. Tällöin Palveluntoimittaja on velvollinen ilmoittamaan esteestä Asiakkaalle mahdollisimman pian.</p>
...
<p><h3>Huomautukset, vaatimukset</h3></p>
...
<p><h3>Palveluihin liittyvät immateriaalioikeudet</h3></p>
...
<p><h3>Salassapito</h3></p>

<p>Sopijapuolet pitävät toisiltaan saamansa luottamukselliseksi tai liikesalaisuudeksi katsottavan aineiston salassa eivätkä käytä tietoja muihin kuin sopimuksen mukaisiin tarkoituksiin. Salassapitovelvollisuus ei koske tietoa, joka on julkista tai yleisesti saatavilla tai jonka sopijapuoli on saanut laillisesti haltuunsa muuten kuin toiselta sopijaosapuolelta.</p>

<p>Tilaaja ei saa antaa sopimuksen sisällöstä tai hinnoista tietoa ulkopuolisille ilman Toimittajan lupaa.</p>

<p>Mikäli sopijaosapuoli on tahallisesti tai törkeällä huolimattomuudella luovuttanut salassa pidettäviä tietoja kolmannelle osapuolelle ja tästä sopimusrikkomuksesta aiheutuneen vahingon voidaan katsoa olevan olennainen, on sopimuksen rikkoja velvollinen suorittamaan kertakaikkisena sopimussakkona toiselle osapuolelle 10.000 euroa. Sopimussakon määrä ei rajoita loukatun osapuolen oikeutta vaatia vahingonkorvausta, mikäli vahinko ylittää sopimussakon määrän.</p>

<p><h3>Erimielisyydet ja niiden ratkaiseminen</h3></p>
...
<p><h3>Sovellettava laki</h3></p>

<p>Tähän sopimukseen sovelletaan yksinomaan Suomen lakia.</p>

<p><h3>Sopimuksen voimassaolo</h3></p>

<p>Sopimus on voimassa toistaiseksi. Sopimuksen irtisanomisaika on kolme (3) kuukautta.</p>
