...
- Veiko Põldkivi, liiketoimintajohtaja, Etunti.
    ...
    <!-- End layout-->
        ...
        <link type="text/css" media="screen" rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/dcslick.css"/>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.slick.2.1.js"></script>



<style>
.wrap {width: 960px; margin: 0 auto;}
.tab { color: #fff; font-weight: bold; margin-bottom: 6px }
.dc-slick-content p {margin-bottom: 1em;}
.dc-slick-content a {color: #fff;}
#dc-slick-0{ width: 100%; margin-left: -3px;  }
</style>

<!--
<div class="wrap">
 <div id="slick-6">
  <p>Blaaa bla bla bla bla bla bla bla bla bla bla bla bla</p>
  <p>Blaaa bla bla bla bla bla bla bla bla bla bla bla bla</p>
  <p>Blaaa bla bla bla bla bla bla bla bla bla bla bla bla</p>
 </div>
</div>
