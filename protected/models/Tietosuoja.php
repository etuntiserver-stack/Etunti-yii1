...
class Tietosuoja extends DB2ActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'asiakas_kayttotarkoitus' => Yii::t('main', 'Käyttötarkoitus'),
			...
			'tyontekija_kayttotarkoitus' => Yii::t('main', 'Käyttötarkoitus'),
			...
			'onlinevaraus_kayttotarkoitus' => Yii::t('main', 'Käyttötarkoitus'),
			...
			'edico_vinkki_kayttotarkoitus' => Yii::t('main', 'Käyttötarkoitus'),
