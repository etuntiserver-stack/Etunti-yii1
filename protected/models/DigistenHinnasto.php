...
class DigistenHinnasto extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'etyo_1000' => Yii::t('main', 'Etyö alle 500'),
			'etyo_1000_2000' => Yii::t('main', 'Etyö 500-1500'),
			'etyo_2000_3000' => Yii::t('main', 'Etyö 1500-3000'),
			'etyo_3000_6000' => Yii::t('main', 'Etyö 3000-6000'),
			'etyo_6000_9000' => Yii::t('main', 'Etyö 6000-9000'),
			'etyo_9000_plus' => Yii::t('main', 'Etyö 9000 Plus'),
			'elasku_1000' => Yii::t('main', 'Elasku alle 500'),
			'elasku_1000_2000' => Yii::t('main', 'Elasku 500-1500'),
			'elasku_2000_3000' => Yii::t('main', 'Elasku 1500-3000'),
			...
			'eonline_1000' => Yii::t('main', 'Eonline alle 500'),
			'eonline_1000_2000' => Yii::t('main', 'Eonline 500-1500'),
			'eonline_2000_3000' => Yii::t('main', 'Eonline 1500-3000'),
			...
			'edico_1000' => Yii::t('main', 'Edico alle 500'),
			'edico_1000_2000' => Yii::t('main', 'Edico 500-1500'),
			'edico_2000_3000' => Yii::t('main', 'Edico 1500-3000'),
