...
/**
 * This is the model class for table "vuosilomat".
 *
 * The followings are the available columns in table 'vuosilomat':
 * @property integer $id
...
class Vuosilomat extends DB2ActiveRecord
{
	 ...
	 * @return Vuosilomat the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, tid, pvm, status', 'safe', 'on'=>'search'),
		);
	}
