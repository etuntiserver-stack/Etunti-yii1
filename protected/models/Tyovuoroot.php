...
public $kpl;
	...
	public function rules()
	{
		...
		return array(
			...
			array('tid, onlinevaraus_id, status, toistuva_id, ilmoitus_avoimista_kohteesta, ilmoitus_myohastyneista_kohteesta, piilota_mobiilista, peruutettu, apuaika, laskutettu, tuoteID, lasku_id, uusi_tilaus', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'tyoajanlaatu' => Yii::t('main', 'Lomat/Poissaolot/Sairaukset'),
		);
	}
