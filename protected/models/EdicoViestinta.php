...
/**
 * This is the model class for table "edico_viestinta".
 *
 * The followings are the available columns in table 'edico_viestinta':
 * @property integer $id
...
class EdicoViestinta extends DB2ActiveRecord
{
	 ...
	 * @return EdicoViestinta the static model class
	 */
