...
class Asiakkaat extends DB2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('kirjeenluokka, muistutuslasku_auto, aktiivinen, netvisorkey', 'numerical', 'integerOnly'=>true),
			array('myyja, postinumero, yhteyshenkilo, yrityksen_nimi, y_tunnus, kaupunki, puhelin, sahkoposti', 'length', 'max'=>100),
			array('tyyppi, laskutus_kanava, osoite, verkkolaskuosoite, salasana, ryhma', 'length', 'max'=>255),
