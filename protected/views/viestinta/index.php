...
?>
        ...
        <div class="tray-center">
              ...
              <h2> <i class="glyphicon glyphicon-envelope"></i> <?php echo Yii::t('main', 'VIESTIT'); ?> 
		<?php echo CHtml::link('','/index.php/viestinta/create',array('class'=>'btn btn-default fa fa-plus')); ?></h2>
