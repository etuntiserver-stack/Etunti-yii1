...
?>
	...
	<TD><input type="text" size="1" name="tkoodi[<?php echo $num; ?>]" id="tkoodi_<?php echo $num; ?>" class="for_tkoodi form-control" value="Kohde:<?php echo $kohde; ?>"></TD>
	<TD><input type="text" name="nimike[<?php echo $num; ?>]" id="nimike_<?php echo $num; ?>" class="form-control" value="<?php echo $ltr->tuotenimi.' '.$from.'-'.$to; ?>"></TD>
	...
	<TD><input type="text" size="10" name="hinta[<?php echo $num; ?>]" id="hinta_<?php echo $num; ?>" class="onlyDigits form-control" value="<?php echo $ltr->hinta_alv_0; ?>"><span class="errmsg"></span></TD>
	<TD>
