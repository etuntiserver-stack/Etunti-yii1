...
?>
	...
	<TD><span class="btn btn-danger poista" for="poista_<?php echo $num; ?>">X</span></TD>
	<TD><input type="text" size="1" name="tkoodi[<?php echo $num; ?>]" id="tkoodi_<?php echo $num; ?>" class="for_tkoodi form-control" value="Asiakas:<?php echo $asiakas; ?>"></TD>
	<TD><input type="text" name="nimike[<?php echo $num; ?>]" id="nimike_<?php echo $num; ?>" class="form-control" value="<?php echo $palvelu.' '.$from.'-'.$to; ?>"></TD>
	<TD><input type="text" size="5" name="kpl[<?php echo $num; ?>]" id="kpl_<?php echo $num; ?>" class="onlyDigits form-control" value="1"><span class="errmsg"></span></TD>
	<TD>
	...
	<TD><input type="text" size="10" name="hinta[<?php echo $num; ?>]" id="hinta_<?php echo $num; ?>" class="onlyDigits form-control" value="<?php echo $hintaForTunti; ?>"><span class="errmsg"></span></TD>
	<TD>
