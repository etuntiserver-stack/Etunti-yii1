...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('kirjallisen_varoituksen')); ?>:</b>
	<?php echo CHtml::encode($data->kirjallisen_varoituksen); ?>
	<br />
