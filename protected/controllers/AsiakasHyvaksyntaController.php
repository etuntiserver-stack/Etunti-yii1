...
class AsiakasHyvaksyntaController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['AsiakasHyvaksynta'];
			if($model->save())
	...
	{
		$model=new AsiakasHyvaksynta('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AsiakasHyvaksynta']))
			$model->attributes=$_GET['AsiakasHyvaksynta'];
	 ...
	 * @return AsiakasHyvaksynta the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AsiakasHyvaksynta::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AsiakasHyvaksynta $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='asiakas-hyvaksynta-form')
		{
