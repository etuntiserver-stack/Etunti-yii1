				...
				foreach($tyopaari as $tp){
					if($tp != $ttekija->id){
						...
						if(isset($tpID->tekijan_nimi)){
							$hasCar = false;
							if(isset($tpID->kortit)) {
								$cards = explode("##***", $tpID->kortit);
								$hasCar = in_array("kortti_Auto", $cards);
								$hasLicense = in_array("kortti_Ajokortti", $cards);
							}
							...
							if($hasCar) {
								$car_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="29.454" height="24" viewBox="0 0 29.454 24"><g transform="translate(0 0)"><path d="M18.909,24a1.456,1.456,0,0,1-1.455-1.455V21.091H5.818v1.454A1.456,1.456,0,0,1,4.363,24H2.909a1.456,1.456,0,0,1-1.455-1.455V20.087a2.885,2.885,0,0,1-.727-1.906V16a2.891,2.891,0,0,1,1-2.182H.819a.544.544,0,0,1-.529-.412L.017,12.315a.545.545,0,0,1,.529-.678H3.267l.756-1.891a5.068,5.068,0,0,1,4.727-3.2h5.509a7.637,7.637,0,1,1,8.186,8.7,2.85,2.85,0,0,1,.1.753v2.182a2.88,2.88,0,0,1-.728,1.906v2.457A1.455,1.455,0,0,1,20.364,24Zm-2.182-6.553c0,.87,1.309.725,2.182.725a1.45,1.45,0,1,0,0-2.9A2.8,2.8,0,0,0,16.727,17.447ZM2.909,16.723a1.372,1.372,0,0,0,1.454,1.45c.873,0,2.181.144,2.181-.725a2.8,2.8,0,0,0-2.181-2.175A1.372,1.372,0,0,0,2.909,16.723Zm3.814-5.9-.905,2.265h10.66A7.637,7.637,0,0,1,14.4,9.455H8.75A2.182,2.182,0,0,0,6.723,10.826ZM24.038,8.472a3.661,3.661,0,0,1,2.527,1.583c.079.113.29.413.439.651a6.03,6.03,0,1,0-10.388-.026c.162-.232.38-.517.456-.625A3.632,3.632,0,0,1,19.6,8.472a.49.49,0,0,1,.372.089,3.145,3.145,0,0,0,3.695,0,.524.524,0,0,1,.31-.092C24,8.469,24.018,8.47,24.038,8.472ZM18.881,5.334a2.938,2.938,0,1,1,2.938,2.921A2.938,2.938,0,0,1,18.881,5.334Z" fill="#939598"/></g></svg>';
								$tplista .= $car_icon;
							}
							if($hasLicense) {
								$drivers_license_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="24.001" height="24" viewBox="0 0 24.001 24"><path d="M12,24A12,12,0,1,1,24,12,12.013,12.013,0,0,1,12,24Zm9.292-9.586c-.929.055-4.066.375-5.432,2.182a7.513,7.513,0,0,0-1.279,4.653A9.634,9.634,0,0,0,21.293,14.414ZM2.706,14.4a9.653,9.653,0,0,0,6.581,6.808A7.624,7.624,0,0,0,8.4,16.6C7.106,14.634,3.715,14.42,2.706,14.4ZM12,9.6A2.4,2.4,0,1,0,14.4,12,2.4,2.4,0,0,0,12,9.6Zm.2-2.154H12.3a22.456,22.456,0,0,1,8.953,1.983A9.6,9.6,0,0,0,2.8,9.262,29.761,29.761,0,0,1,12.2,7.446Z" fill="#939598"/></svg>';
								$tplista .= $drivers_license_icon;
							}
